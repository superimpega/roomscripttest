...
//		+ 	'<p id="plugbot-btn-userlist" style="color:#ED1C24">userlist</p>'
		+ 	'<p id="plugbot-btn-facebook" style="color:#ED1C24"><a style="color: #0000FF" href="https://www.facebook.com/groups/ElectronicElements.plug.dj/" target="_blank">Facebook</a></p>'
		+ 	'<p id="plugbot-btn-twitter" style="color:#ED1C24"><a style="color: #00BEF6" href="https://twitter.com/ElectronicELE/" target="_blank">twitter</a></p>'	
		+	'<p id="plugbot-btn-strobe" style="color:#6300C6"><s>strobe</s></p>'
//		+	'<p id="plugbot-btn-tinychat" style="color:#ED1C24"><a style="color: #D80000" href="http://tinychat.com/electelements/" target="_blank">tinychat</a></p>'
...
//		+ 	'<h2 id="plugbot-btn-minecraft" style="color:#F88017"> <a style="color:#3FFF00"> Minecraft Server </a> </br> Server Status: <a style="color:#3FFF00"> Online </a> </br> Server Ip: <a style="color:#3FFF00"> play.punkcraft.org</a></h2>'
		+	'<h2 id="plugbot-btn-strobeinfo" style="color:#F88017"> <a style="color:#3FFF00"></a> </br>use "/me /on" to turn on strobelights! "/me /off" to turn off!</h2>'
...
//autochat
/*
function isBoris() { return API.getSelf().username == "Bᴀss Aᴅᴅɩcʈ"; }
